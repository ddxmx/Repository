package com.test.day04.annotation.config;

import com.test.day04.annotation.bean.Person;
import com.test.day04.annotation.bean.Student;
import com.test.day04.annotation.bean.Teacher;
