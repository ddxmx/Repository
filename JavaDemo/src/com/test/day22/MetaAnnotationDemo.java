 ...
 * <p>
 * Documented：标识注解可以被生成在javadoc中，默认不生成
 * <p>
 * Inherited：表示注解可以被子类继承，但这并不是真的继承，只是通过使用@Inherited，可以让子类Class对象使用getAnnotations()获取父类被@Inherited修饰的注解
 */
