...
public class StaticDemo {
    public static void main(String[] args) {
        ...
        System.out.println(c1); // Chinese{name='张三', age=20, country=中国}
        System.out.println(c2); // Chinese{name='李四', age=24, country=中国}
        ...
        System.out.println(c2); // Chinese{name='李四', age=24, country=China}
