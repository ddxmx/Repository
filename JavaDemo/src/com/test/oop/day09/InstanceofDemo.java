...
public class InstanceofDemo {
    public static void main(String[] args) {
        ...
        // 运行失败，java.lang.ClassCastException: com.test.oop.day13.Producer cannot be cast to com.test.oop.day13.Consumer
        ...
        User user3 = (User) obj; // 编译运行都通过

        // Consumer consumer3 = (Consumer) new User(); // 编译通过，运行不通过

        // Consumer consumer4 = (Consumer) new Producer(); // 编译不通过，Producer类型和Consumer类型之间没有父子关系，不能强转

        Object obj5 = new Consumer();
        // Producer producer = (Producer) obj5; // 编译通过，运行不通过，Producer类型和Consumer类型之间没有父子关系，不能强转
    }
}
