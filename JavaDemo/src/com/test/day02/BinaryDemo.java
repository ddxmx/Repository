 ...
 * 使用原码的方式 1-1=1+(-1)=0000_0001 + 1000_0001，不用原码表示是因为原码计算结果不正确
...
public class BinaryDemo {
    public static void main(String[] args) {
        ...
        //十进制转换其他进制表示形式
        System.out.println("********************************");
        String value = Integer.toString(num, 2); //十进制转换为二进制
        System.out.println(value); //-1100
        String value2 = Integer.toString(num, 8); //十进制转换为八进制
        System.out.println(value2); //-14
        String value3 = Integer.toString(num, 16); //十进制转换为十六进制
        ...
        //11_111_111_111_111_111_111_111_111_110_100
        System.out.println(Integer.toOctalString(num)); //37777777764
        //1111_1111_1111_1111_1111_1111_1111_0100
