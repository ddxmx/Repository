...
public class TernaryOperDemo {
    public static void main(String[] args) {
        //System.out.println(true?System.out.println(true):System.out.println(false)); //编译错误，无法使用变量进行接收
        ...
        Object value = String.valueOf(System.currentTimeMillis()).matches("\\d{13}") ? 2 : "abc";
