package com.test.io.day17.properties;
...
public class PropertiesDemo {
    public static void main(String[] args) throws IOException {
        ...
        // 5、从类同级路径查找，file:/E:/IdeaProjects/java-basic/out/production/javaSE/com/test/collection/day18/properties/jdbc.properties
        System.out.println(PropertiesDemo.class.getResource("jdbc.properties"));
