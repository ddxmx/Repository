...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.printf("My name is %s.My age is %d.My salary is %8.1f", "Jerry", 24, 8000.45);
        System.out.println();
        // String.format和printf格式化后的结果一致
        System.out.println(String.format("My name is %s.My age is %d.My salary is %8.1f", "Jerry", 24, 8000.45));
    }
}
