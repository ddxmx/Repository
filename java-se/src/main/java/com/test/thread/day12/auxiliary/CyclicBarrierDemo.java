package com.test.thread.day12.auxiliary;
...
public class CyclicBarrierDemo {
    public static void main(String[] args) {
         ...
         */
        CyclicBarrier cyclicBarrier = new CyclicBarrier(dragonBallSize,
                () -> System.out.println(Thread.currentThread().getName() + "：聚齐七颗龙珠，召唤神龙"));
