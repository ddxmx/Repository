...
/**
 * 接口中的方法
 * 1、默认方法：当接口中需要提供新的功能，方法需要在接口中定义。但是所有子类必须要覆写接口中的抽象方法。
...
/**
 * 子类继承父类，并实现多个接口
 * 1、实现的多个接口中方法重名，子类需要复写方法
 * 2、继承的类和实现的接口中方法重名，不要求子类复写方法，调用的是继承类中的方法
 */
...
public class InterfaceMethodDemo {
    public static void main(String[] args) {
        ...
        sub.defaultMethod3(); // SuperClass.defaultMethod3

        System.out.println("==========调用子类继承的方法，父类中不存在，从父接口中查找==========");
        sub.defaultMethod4(); // SuperInterfaceA.defaultMethod4

        System.out.println("==========子类中调用父类和父接口方法==========");
        sub.test();
    }
}
